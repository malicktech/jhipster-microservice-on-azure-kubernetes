...
```
$ docker image tag store citizendiop/store
$ docker push citizendiop/store
$ docker image tag invoice citizendiop/invoice
$ docker push citizendiop/invoice
$ docker image tag notification citizendiop/notification
$ docker push citizendiop/notification
```
